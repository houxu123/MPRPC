...
// bytes pwd = 2;
inline void GetFriendsListRequest::clear_pwd() {
  pwd_.ClearToEmpty();
}
inline const std::string& GetFriendsListRequest::pwd() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendsListRequest.pwd)
  return _internal_pwd();
}
inline void GetFriendsListRequest::set_pwd(const std::string& value) {
  _internal_set_pwd(value);
  // @@protoc_insertion_point(field_set:fixbug.GetFriendsListRequest.pwd)
}
inline std::string* GetFriendsListRequest::mutable_pwd() {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendsListRequest.pwd)
  return _internal_mutable_pwd();
}
inline const std::string& GetFriendsListRequest::_internal_pwd() const {
  return pwd_.Get();
}
inline void GetFriendsListRequest::_internal_set_pwd(const std::string& value) {
  
  pwd_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void GetFriendsListRequest::set_pwd(std::string&& value) {
  
  pwd_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:fixbug.GetFriendsListRequest.pwd)
}
inline void GetFriendsListRequest::set_pwd(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  pwd_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:fixbug.GetFriendsListRequest.pwd)
}
inline void GetFriendsListRequest::set_pwd(const void* value,
    size_t size) {
  
  pwd_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:fixbug.GetFriendsListRequest.pwd)
}
inline std::string* GetFriendsListRequest::_internal_mutable_pwd() {
  
  return pwd_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* GetFriendsListRequest::release_pwd() {
  // @@protoc_insertion_point(field_release:fixbug.GetFriendsListRequest.pwd)
  return pwd_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void GetFriendsListRequest::set_allocated_pwd(std::string* pwd) {
  if (pwd != nullptr) {
  ...
  pwd_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), pwd,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:fixbug.GetFriendsListRequest.pwd)
}
